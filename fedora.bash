...
function generate_diff {
  ...
  for PROJ in nova glance keystone swift quantum cinder python-novaclient python-glanceclient python-keystoneclient python-swiftclient python-quantumclient python-cinderclient; do
